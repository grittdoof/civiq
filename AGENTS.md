# AGENTS.md — Historique de développement CiviQ

> Ce fichier sert d'historique conversationnel pour le développement de CiviQ avec Codex.ai.
...
- **Docs** :
  - AGENTS.md enrichi de Sessions 3→6 (ce fichier)
